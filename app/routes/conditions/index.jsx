...
export default function Index() {
    ...
    >
      ...
      <GridItem colSpan={1} pl='2' area={'nav'}>
        ...
        <Box  borderColor="#CDFCF6" borderRadius='lg' borderWidth='5px' alignItems='center' margin={'auto'}>
          <Box>
      ...
      <GridItem marginRight={9} colSpan={3} pl='2' bg='white' area={'main'}>
        ...
        <Center>
      <Box w={700} borderColor="#CDFCF6" borderRadius='lg' borderWidth='5px' alignItems='center' margin={1} >
