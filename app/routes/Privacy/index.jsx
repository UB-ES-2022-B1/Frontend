...
export default function Index() {
    ...
    >
      ...
      <GridItem pl='2' area={'header'}>
        ...
        <Spacer />
        <Heading as='h2' size='xl'>Airbnb Privacy</Heading>
      </GridItem>
      ...
      <Box w={700} borderColor="#CDFCF6" borderRadius='lg' borderWidth='3px' alignItems='center' margin={1} >
         ...
         <Box>
            ...
            <Text><Text as='b'>Identity Verification and Payment Information.</Text>Such as images of your government issued ID (as permitted by applicable laws), your ID number or other verification information, bank account or payment account information. ​​If you are not an Airbnb user, we may receive payment information relating to you, such as when an Airbnb user provides your payment card to complete a booking. If a copy of your ID is provided to us, we may scan, use, and store information contained in your ID to verify your identity.</Text>
         </Box>
         <Box>
            ...
            <Text><Text as='b'>Information About Others.</Text> Such as a payment instrument belonging to another person or information about a co-traveler. By providing us with personal information about others, you certify that you have permission to provide that information to Airbnb for the purposes described in this Privacy Policy, have shared the Airbnb Privacy Policy with them, and they have read and understood that it applies to them. </Text>
