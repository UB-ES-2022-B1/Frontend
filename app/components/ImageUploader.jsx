...
export default function ImageUploader(props) {
  ...
  const showImage = (image) => {
    ...
    return {
      id: image.id, url: objectUrl, remove: () => {
    ...
    <><Container my="12">
      <Box >
        <Heading marginY='25px' lineHeight={1.1} fontSize={{ base: '2xl', md: '3xl' }}>
          Add some images of your accommodation
        </Heading>
        <Text marginY='25px'>To start, you will need 5 photos. Then you can add more or make changes.</Text>
      </Box>
